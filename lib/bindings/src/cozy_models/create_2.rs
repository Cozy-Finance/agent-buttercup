...
pub mod create_2 {
    ...
    pub static CREATE2_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub struct Create2<M>(::ethers::contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for Create2<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(Create2))
                .field(&self.address())
                .finish()
        }
    }
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for Create2<M> {
