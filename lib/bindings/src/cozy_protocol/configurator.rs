...
pub mod configurator {
    ...
    pub static CONFIGURATOR_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct Configurator<M>(::ethers::contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for Configurator<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(Configurator)).field(&self.address()).finish()
        }
    }
    ...
    impl ::ethers::contract::ContractRevert for ConfiguratorErrors {
    ...
    impl ::ethers::contract::EthLogDecode for ConfiguratorEvents {
        fn decode_log(
