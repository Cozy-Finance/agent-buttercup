...
pub mod configurator_1 {
    ...
    pub static CONFIGURATOR_1_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M> ::core::fmt::Debug for Configurator_1<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(Configurator_1))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> Configurator_1<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, Configurator_1Events>
        {
            self.0
    ...
    impl ::ethers::contract::EthLogDecode for Configurator_1Events {
        fn decode_log(
            ...
            if let Ok(decoded) = OwnershipTransferStartedFilter::decode_log(log) {
                return Ok(Configurator_1Events::OwnershipTransferStartedFilter(
                    decoded,
                ));
            }
