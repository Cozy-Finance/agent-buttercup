...
pub mod set_inspector {
    ...
    pub static SETINSPECTOR_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct SetInspector<M>(::ethers::contract::Contract<M>);
    ...
    impl ::ethers::contract::ContractRevert for SetInspectorErrors {
    ...
    impl ::ethers::contract::EthLogDecode for SetInspectorEvents {
        fn decode_log(
