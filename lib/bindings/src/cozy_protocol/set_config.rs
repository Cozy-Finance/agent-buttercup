...
pub mod set_config {
    ...
    pub static SETCONFIG_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct SetConfig<M>(::ethers::contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for SetConfig<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(SetConfig)).field(&self.address()).finish()
        }
    }
