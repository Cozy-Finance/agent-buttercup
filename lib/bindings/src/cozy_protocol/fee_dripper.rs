...
pub mod fee_dripper {
    ...
    pub static FEEDRIPPER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
        });
    pub struct FeeDripper<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> FeeDripper<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, FeeDripperEvents> {
            self.0
                .event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for FeeDripper<M> {
    ...
    impl ::ethers::contract::ContractRevert for FeeDripperErrors {
    ...
    impl ::ethers::contract::EthLogDecode for FeeDripperEvents {
        fn decode_log(
