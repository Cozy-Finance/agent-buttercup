...
pub mod supply_side_lib {
    ...
    pub static SUPPLYSIDELIB_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    impl<M> ::core::fmt::Debug for SupplySideLib<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(SupplySideLib)).field(&self.address()).finish()
        }
    }
