...
pub mod packed_string_lib {
    ...
    pub static PACKEDSTRINGLIB_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ...
    pub struct PackedStringLib<M>(::ethers::contract::Contract<M>);
