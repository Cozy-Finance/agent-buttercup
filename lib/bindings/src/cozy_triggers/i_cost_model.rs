...
pub mod i_cost_model {
    ...
    pub static ICOSTMODEL_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> ICostModel<M> {
        ...
        pub fn should_update(&self) -> ::ethers::contract::builders::ContractCall<M, bool> {
            self.0
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for ICostModel<M> {
