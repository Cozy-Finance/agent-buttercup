...
pub mod protection_claimer {
    ...
    pub static PROTECTIONCLAIMER_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct ProtectionClaimer<M>(::ethers::contract::Contract<M>);
    ...
    impl ::ethers::contract::ContractRevert for ProtectionClaimerErrors {
    ...
    impl ::ethers::contract::EthLogDecode for ProtectionClaimerEvents {
        fn decode_log(
