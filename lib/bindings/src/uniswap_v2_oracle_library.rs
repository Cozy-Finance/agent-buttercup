pub use uniswap_v2_oracle_library::*;
...
pub mod uniswap_v2_oracle_library {
    ...
    impl<M> ::core::ops::Deref for UniswapV2OracleLibrary<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for UniswapV2OracleLibrary<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for UniswapV2OracleLibrary<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(UniswapV2OracleLibrary))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> UniswapV2OracleLibrary<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                UNISWAPV2ORACLELIBRARY_ABI.clone(),
                UNISWAPV2ORACLELIBRARY_BYTECODE.clone().into(),
                client,
            );
