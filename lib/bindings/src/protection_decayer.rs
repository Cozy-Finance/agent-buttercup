...
pub mod protection_decayer {
    ...
    pub static PROTECTIONDECAYER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers::contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
        });
    pub struct ProtectionDecayer<M>(::ethers::contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> ProtectionDecayer<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, ProtectionDecayerEvents>
        {
            self.0
    ...
    impl ::ethers::contract::ContractRevert for ProtectionDecayerErrors {
    ...
    impl ::ethers::contract::EthLogDecode for ProtectionDecayerEvents {
        fn decode_log(
