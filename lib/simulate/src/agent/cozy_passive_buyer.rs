...
pub struct CozyPassiveBuyer<AgentState: AgentStatus> {
    /// Name of the agent.
    pub name: String,
...
impl<AgentState: AgentStatus> Identifiable for CozyPassiveBuyer<AgentState> {
    fn name(&self) -> String {
        self.name.clone()
    }
}

impl Agent for CozyPassiveBuyer<IsActive> {
...
impl CozyPassiveBuyer<NotActive> {
...
impl CozyPassiveBuyer<IsActive> {}
