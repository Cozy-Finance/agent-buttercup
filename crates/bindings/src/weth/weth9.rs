...
pub mod weth9 {
    ...
    pub struct WETH9<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> WETH9<M> {
        ...
        pub fn withdrawal_filter(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, WithdrawalFilter> {
            self.0.event()
        }
        /// Returns an `Event` builder for all the events of this contract.
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, WETH9Events> {
            self.0
                .event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for WETH9<M> {
    ...
    impl ::ethers_contract::EthLogDecode for WETH9Events {
        fn decode_log(
