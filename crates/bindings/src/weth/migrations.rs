...
pub mod migrations {
    ...
    pub static MIGRATIONS_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub struct Migrations<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for Migrations<M> {
