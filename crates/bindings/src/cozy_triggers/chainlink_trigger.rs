...
pub mod chainlink_trigger {
    ...
    pub static CHAINLINKTRIGGER_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> ChainlinkTrigger<M> {
        ...
        pub fn oracle_to_scale(&self) -> ::ethers_contract::builders::ContractCall<M, u8> {
            self.0
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, ChainlinkTriggerEvents>
        {
            self.0
    ...
    impl ::ethers_contract::ContractRevert for ChainlinkTriggerErrors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector == <InvalidPrice as ::ethers_contract::EthError>::selector() => true,
                _ if selector
                ...
                _ if selector == <InvalidTimestamp as ::ethers_contract::EthError>::selector() => {
                    true
                }
                _ if selector == <SetLimitReached as ::ethers_contract::EthError>::selector() => {
                    true
                }
                _ if selector == <StaleOraclePrice as ::ethers_contract::EthError>::selector() => {
                    true
                }
