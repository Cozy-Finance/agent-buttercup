...
pub mod base_trigger {
    ...
    pub static BASETRIGGER_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers_contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
        });
    pub struct BaseTrigger<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> BaseTrigger<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, BaseTriggerEvents> {
            self.0
                .event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for BaseTrigger<M> {
    ...
    impl ::ethers_contract::ContractRevert for BaseTriggerErrors {
    ...
    impl ::ethers_contract::EthLogDecode for BaseTriggerEvents {
        fn decode_log(
