...
pub mod i_base_trigger {
    ...
    pub static IBASETRIGGER_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M> ::core::fmt::Debug for IBaseTrigger<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(IBaseTrigger))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IBaseTrigger<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, IBaseTriggerEvents>
        {
            self.0
                .event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for IBaseTrigger<M> {
