...
pub mod metadata {
    ...
    pub static ISET_NAME: &str = "ISet";
    pub static ISET_PATH: &str = "contracts/interfaces/ISet.sol";
    pub static IERC20_NAME: &str = "IERC20";
    pub static IERC20_PATH: &str = "contracts/interfaces/IERC20.sol";
    pub static ITRIGGER_NAME: &str = "ITrigger";
    pub static ITRIGGER_PATH: &str = "contracts/interfaces/ITrigger.sol";
    pub static IUMATRIGGERFACTORY_NAME: &str = "IUMATriggerFactory";
    pub static IUMATRIGGERFACTORY_PATH: &str = "contracts/interfaces/IUMATriggerFactory.sol";
    pub static IUMATRIGGER_NAME: &str = "IUMATrigger";
    pub static IUMATRIGGER_PATH: &str = "contracts/interfaces/IUMATrigger.sol";
    ...
    pub static FLEXIBLETRIGGER_NAME: &str = "FlexibleTrigger";
    pub static FLEXIBLETRIGGER_PATH: &str = "contracts/FlexibleTrigger.sol";
    ...
    pub static DUMMYTRIGGER_PATH: &str = "contracts/DummyTrigger.sol";
    ...
    pub static IMANAGER_PATH: &str = "contracts/interfaces/IManager.sol";
    pub static BASETRIGGER_NAME: &str = "BaseTrigger";
    pub static BASETRIGGER_PATH: &str = "contracts/abstract/BaseTrigger.sol";
    pub static UMATRIGGER_NAME: &str = "UMATrigger";
    pub static UMATRIGGER_PATH: &str = "contracts/UMATrigger.sol";
    pub static ICHAINLINKTRIGGER_NAME: &str = "IChainlinkTrigger";
    pub static ICHAINLINKTRIGGER_PATH: &str = "contracts/interfaces/IChainlinkTrigger.sol";
    pub static FIXEDPRICEAGGREGATOR_NAME: &str = "FixedPriceAggregator";
    pub static FIXEDPRICEAGGREGATOR_PATH: &str = "contracts/FixedPriceAggregator.sol";
}
