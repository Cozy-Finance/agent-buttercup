...
pub mod i_governable {
    ...
    pub static IGOVERNABLE_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for IGovernable<M> {
