...
pub mod ierc20 {
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for IERC20<M> {
    ...
    impl ::core::convert::From<PermitCall> for IERC20Calls {
