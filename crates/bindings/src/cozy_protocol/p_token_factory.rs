...
pub mod p_token_factory {
    ...
    pub static PTOKENFACTORY_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub struct PTokenFactory<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for PTokenFactory<M> {
