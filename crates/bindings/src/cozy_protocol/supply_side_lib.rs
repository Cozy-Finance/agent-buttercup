...
pub mod supply_side_lib {
    ...
    pub static SUPPLYSIDELIB_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for SupplySideLib<M> {
