...
pub mod governable {
    ...
    pub static GOVERNABLE_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers_contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
        });
    pub struct Governable<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> Governable<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, GovernableEvents> {
            self.0
                .event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for Governable<M> {
    ...
    impl ::ethers_contract::ContractRevert for GovernableErrors {
    ...
    impl ::ethers_contract::EthLogDecode for GovernableEvents {
        fn decode_log(
