...
pub mod i_weth {
    ...
    pub static IWETH_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for IWeth<M> {
    ...
    pub struct AllowanceReturn {
        pub remaining_allowance: ::ethers::core::types::U256,
    }
