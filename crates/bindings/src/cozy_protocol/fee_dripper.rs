...
pub mod fee_dripper {
    ...
    pub static FEEDRIPPER_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ...
    impl<M> ::core::fmt::Debug for FeeDripper<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(FeeDripper)).field(&self.address()).finish()
        }
    }
