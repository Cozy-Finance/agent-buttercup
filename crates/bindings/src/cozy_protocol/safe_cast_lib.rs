...
pub mod safe_cast_lib {
    ...
    pub static SAFECASTLIB_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub struct SafeCastLib<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for SafeCastLib<M> {
