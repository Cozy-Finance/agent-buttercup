...
pub mod protection_seller {
    ...
    pub static PROTECTIONSELLER_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(|| {
        ::ethers::core::utils::__serde_json::from_str(__ABI)
            .expect("ABI is always valid")
    });
    pub struct ProtectionSeller<M>(::ethers::contract::Contract<M>);
    ...
    impl ::ethers::contract::ContractRevert for ProtectionSellerErrors {
    ...
    impl ::ethers::contract::EthLogDecode for ProtectionSellerEvents {
        fn decode_log(
