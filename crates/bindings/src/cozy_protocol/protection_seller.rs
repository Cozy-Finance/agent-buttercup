...
pub mod protection_seller {
    ...
    pub static PROTECTIONSELLER_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M> ::core::fmt::Debug for ProtectionSeller<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(ProtectionSeller))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> ProtectionSeller<M> {
        ...
        pub fn sell(
            ...
            owner: ::ethers::core::types::Address,
        ) -> ::ethers_contract::builders::ContractCall<M, (u128, ::ethers::core::types::U256)>
        {
            self.0
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, ProtectionSellerEvents>
        {
            self.0
