...
pub mod protection_seller {
    ...
    impl<M: ::ethers::providers::Middleware> ProtectionSeller<M> {
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            ProtectionSellerEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>>
    for ProtectionSeller<M> {
    ...
    pub enum ProtectionSellerErrors {
    ...
    impl ::ethers::core::abi::AbiDecode for ProtectionSellerErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ProtectionSellerErrors {
    ...
    impl ::ethers_contract::ContractRevert for ProtectionSellerErrors {
    ...
    impl ::core::fmt::Display for ProtectionSellerErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::InsufficientBalance(element) => {
    ...
    impl ::core::convert::From<::std::string::String> for ProtectionSellerErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<InsufficientBalance> for ProtectionSellerErrors {
        fn from(value: InsufficientBalance) -> Self {
            Self::InsufficientBalance(value)
        }
    }
    impl ::core::convert::From<InvalidState> for ProtectionSellerErrors {
        fn from(value: InvalidState) -> Self {
            Self::InvalidState(value)
        }
    }
    impl ::core::convert::From<InvalidStateTransition> for ProtectionSellerErrors {
        fn from(value: InvalidStateTransition) -> Self {
            Self::InvalidStateTransition(value)
        }
    }
    impl ::core::convert::From<RoundsToZero> for ProtectionSellerErrors {
        fn from(value: RoundsToZero) -> Self {
            Self::RoundsToZero(value)
        }
    }
    impl ::core::convert::From<SafeCastFailed> for ProtectionSellerErrors {
    ...
    #[derive(Clone, ::ethers_contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum ProtectionSellerEvents {
        ApprovalFilter(ApprovalFilter),
        FeesAccruedFilter(FeesAccruedFilter),
        SellFilter(SellFilter),
        TransferFilter(TransferFilter),
    }
    impl ::ethers_contract::EthLogDecode for ProtectionSellerEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(ProtectionSellerEvents::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = FeesAccruedFilter::decode_log(log) {
                return Ok(ProtectionSellerEvents::FeesAccruedFilter(decoded));
            }
            if let Ok(decoded) = SellFilter::decode_log(log) {
                return Ok(ProtectionSellerEvents::SellFilter(decoded));
            }
            if let Ok(decoded) = TransferFilter::decode_log(log) {
                return Ok(ProtectionSellerEvents::TransferFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for ProtectionSellerEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ApprovalFilter> for ProtectionSellerEvents {
        fn from(value: ApprovalFilter) -> Self {
            Self::ApprovalFilter(value)
        }
    }
    impl ::core::convert::From<FeesAccruedFilter> for ProtectionSellerEvents {
        fn from(value: FeesAccruedFilter) -> Self {
            Self::FeesAccruedFilter(value)
        }
    }
    impl ::core::convert::From<SellFilter> for ProtectionSellerEvents {
        fn from(value: SellFilter) -> Self {
            Self::SellFilter(value)
        }
    }
    impl ::core::convert::From<TransferFilter> for ProtectionSellerEvents {
    ...
    #[derive(Clone, ::ethers_contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum ProtectionSellerCalls {
    ...
    impl ::ethers::core::abi::AbiDecode for ProtectionSellerCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
            ...
            if let Ok(decoded)
                = <PreviewSaleCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for ProtectionSellerCalls {
    ...
    impl ::core::fmt::Display for ProtectionSellerCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<DomainSeparatorCall> for ProtectionSellerCalls {
        fn from(value: DomainSeparatorCall) -> Self {
            Self::DomainSeparator(value)
        }
    }
    impl ::core::convert::From<AccountingCall> for ProtectionSellerCalls {
        fn from(value: AccountingCall) -> Self {
            Self::Accounting(value)
        }
    }
    impl ::core::convert::From<AllowanceCall> for ProtectionSellerCalls {
        fn from(value: AllowanceCall) -> Self {
            Self::Allowance(value)
        }
    }
    impl ::core::convert::From<ApproveCall> for ProtectionSellerCalls {
        fn from(value: ApproveCall) -> Self {
            Self::Approve(value)
        }
    }
    impl ::core::convert::From<AssetCall> for ProtectionSellerCalls {
        fn from(value: AssetCall) -> Self {
            Self::Asset(value)
        }
    }
    impl ::core::convert::From<BackstopCall> for ProtectionSellerCalls {
        fn from(value: BackstopCall) -> Self {
            Self::Backstop(value)
        }
    }
    impl ::core::convert::From<BalanceOfCall> for ProtectionSellerCalls {
        fn from(value: BalanceOfCall) -> Self {
            Self::BalanceOf(value)
        }
    }
    impl ::core::convert::From<BalanceOfMaturedCall> for ProtectionSellerCalls {
        fn from(value: BalanceOfMaturedCall) -> Self {
            Self::BalanceOfMatured(value)
        }
    }
    impl ::core::convert::From<CumulativeMintedCall> for ProtectionSellerCalls {
        fn from(value: CumulativeMintedCall) -> Self {
            Self::CumulativeMinted(value)
        }
    }
    impl ::core::convert::From<DecimalsCall> for ProtectionSellerCalls {
        fn from(value: DecimalsCall) -> Self {
            Self::Decimals(value)
        }
    }
    impl ::core::convert::From<DripSupplierFeesCall> for ProtectionSellerCalls {
        fn from(value: DripSupplierFeesCall) -> Self {
            Self::DripSupplierFees(value)
        }
    }
    impl ::core::convert::From<GetMintsCall> for ProtectionSellerCalls {
        fn from(value: GetMintsCall) -> Self {
            Self::GetMints(value)
        }
    }
    impl ::core::convert::From<ManagerCall> for ProtectionSellerCalls {
        fn from(value: ManagerCall) -> Self {
            Self::Manager(value)
        }
    }
    impl ::core::convert::From<MarketsCall> for ProtectionSellerCalls {
        fn from(value: MarketsCall) -> Self {
            Self::Markets(value)
        }
    }
    impl ::core::convert::From<MintsCall> for ProtectionSellerCalls {
        fn from(value: MintsCall) -> Self {
            Self::Mints(value)
        }
    }
    impl ::core::convert::From<NameCall> for ProtectionSellerCalls {
        fn from(value: NameCall) -> Self {
            Self::Name(value)
        }
    }
    impl ::core::convert::From<NoncesCall> for ProtectionSellerCalls {
        fn from(value: NoncesCall) -> Self {
            Self::Nonces(value)
        }
    }
    impl ::core::convert::From<PermitCall> for ProtectionSellerCalls {
        fn from(value: PermitCall) -> Self {
            Self::Permit(value)
        }
    }
    impl ::core::convert::From<PreviewSaleCall> for ProtectionSellerCalls {
        fn from(value: PreviewSaleCall) -> Self {
            Self::PreviewSale(value)
        }
    }
    impl ::core::convert::From<PtokenFactoryCall> for ProtectionSellerCalls {
        fn from(value: PtokenFactoryCall) -> Self {
            Self::PtokenFactory(value)
        }
    }
    impl ::core::convert::From<SellCall> for ProtectionSellerCalls {
        fn from(value: SellCall) -> Self {
            Self::Sell(value)
        }
    }
    impl ::core::convert::From<SetConfigCall> for ProtectionSellerCalls {
        fn from(value: SetConfigCall) -> Self {
            Self::SetConfig(value)
        }
    }
    impl ::core::convert::From<SetStateCall> for ProtectionSellerCalls {
        fn from(value: SetStateCall) -> Self {
            Self::SetState(value)
        }
    }
    impl ::core::convert::From<SymbolCall> for ProtectionSellerCalls {
        fn from(value: SymbolCall) -> Self {
            Self::Symbol(value)
        }
    }
    impl ::core::convert::From<TotalSupplyCall> for ProtectionSellerCalls {
        fn from(value: TotalSupplyCall) -> Self {
            Self::TotalSupply(value)
        }
    }
    impl ::core::convert::From<TransferCall> for ProtectionSellerCalls {
        fn from(value: TransferCall) -> Self {
            Self::Transfer(value)
        }
    }
    impl ::core::convert::From<TransferFromCall> for ProtectionSellerCalls {
        fn from(value: TransferFromCall) -> Self {
            Self::TransferFrom(value)
        }
    }
    impl ::core::convert::From<TriggerLookupsCall> for ProtectionSellerCalls {
