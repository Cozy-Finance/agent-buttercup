...
pub mod set_common {
    ...
    pub static SETCOMMON_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers_contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
        });
    pub struct SetCommon<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> SetCommon<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, SetCommonEvents> {
            self.0
                .event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for SetCommon<M> {
    ...
    impl ::ethers_contract::ContractRevert for SetCommonErrors {
    ...
    impl ::ethers_contract::EthLogDecode for SetCommonEvents {
        fn decode_log(
