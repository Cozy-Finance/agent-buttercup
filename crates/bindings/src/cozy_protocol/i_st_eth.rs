...
pub mod i_st_eth {
    ...
    pub static ISTETH_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers_contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
        });
    pub struct IStETH<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for IStETH<M> {
