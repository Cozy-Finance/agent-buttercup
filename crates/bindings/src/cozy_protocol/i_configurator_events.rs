...
pub mod i_configurator_events {
    ...
    pub static ICONFIGURATOREVENTS_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers_contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
        });
    pub struct IConfiguratorEvents<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> IConfiguratorEvents<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, IConfiguratorEventsEvents>
        {
            self.0
    ...
    impl ::ethers_contract::EthLogDecode for IConfiguratorEventsEvents {
        fn decode_log(
