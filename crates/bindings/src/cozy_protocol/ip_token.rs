...
pub mod ip_token {
    ...
    pub static IPTOKEN_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IPToken<M>(::ethers::contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for IPToken<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(IPToken)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IPToken<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IPTokenEvents> {
    ...
    impl ::ethers::contract::EthLogDecode for IPTokenEvents {
        fn decode_log(
    ...
    impl ::ethers::core::abi::AbiDecode for IPTokenCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <InactiveTransitionTimeCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
