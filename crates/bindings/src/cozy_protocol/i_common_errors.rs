...
pub mod i_common_errors {
    ...
    pub static ICOMMONERRORS_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers_contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
        });
    pub struct ICommonErrors<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for ICommonErrors<M> {
    ...
    impl ::ethers_contract::ContractRevert for ICommonErrorsErrors {
