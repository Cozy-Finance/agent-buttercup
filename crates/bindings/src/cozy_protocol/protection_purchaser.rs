...
pub mod protection_purchaser {
    ...
    pub static PROTECTIONPURCHASER_ABI: ::ethers_contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    impl ::ethers_contract::ContractRevert for ProtectionPurchaserErrors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector
                    == <InvalidPurchase as ::ethers_contract::EthError>::selector() => {
                    true
                }
                _ if selector
    ...
    impl ::ethers::core::abi::AbiDecode for ProtectionPurchaserCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <RemainingProtectionCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
