...
pub mod set {
    ...
    pub static SET_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> = ::ethers_contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct Set<M>(::ethers_contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for Set<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(Set)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> Set<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers_contract::Contract::new(address.into(), SET_ABI.clone(), client),
            )
        }
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, SetEvents> {
    ...
    impl ::ethers_contract::ContractRevert for SetErrors {
    ...
    impl ::ethers_contract::EthLogDecode for SetEvents {
        fn decode_log(
