...
pub mod set {
    ...
    pub static SET_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> Set<M> {
        ...
        pub fn market_state_updated_filter(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, MarketStateUpdatedFilter>
        {
            self.0.event()
        }
        ...
        pub fn set_state_updated_filter(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, SetStateUpdatedFilter>
        {
            self.0.event()
        }
    ...
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for Set<M> {
    ...
    impl ::ethers_contract::ContractRevert for SetErrors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector == <Initialized as ::ethers_contract::EthError>::selector() => true,
                _ if selector
                ...
                _ if selector == <InvalidDeposit as ::ethers_contract::EthError>::selector() => {
                    true
                }
                ...
                _ if selector == <UnpackableString as ::ethers_contract::EthError>::selector() => {
                    true
                }
                _ => false,
            }
