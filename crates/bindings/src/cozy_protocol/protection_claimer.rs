...
pub mod protection_claimer {
    ...
    pub static PROTECTIONCLAIMER_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M> ::core::fmt::Debug for ProtectionClaimer<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(ProtectionClaimer))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> ProtectionClaimer<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, ProtectionClaimerEvents>
        {
            self.0
