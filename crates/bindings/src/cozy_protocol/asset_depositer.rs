...
pub mod asset_depositer {
    ...
    pub static ASSETDEPOSITER_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers_contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
        });
    pub struct AssetDepositer<M>(::ethers_contract::Contract<M>);
    ...
    impl<M> ::core::fmt::Debug for AssetDepositer<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(AssetDepositer))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> AssetDepositer<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, AssetDepositerEvents>
        {
            self.0
    ...
    impl ::ethers_contract::ContractRevert for AssetDepositerErrors {
    ...
    impl ::ethers_contract::EthLogDecode for AssetDepositerEvents {
        fn decode_log(
