...
pub mod ip_token_factory_events {
    ...
    pub static IPTOKENFACTORYEVENTS_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
        ::ethers_contract::Lazy::new(|| {
            ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid")
        });
    pub struct IPTokenFactoryEvents<M>(::ethers_contract::Contract<M>);
    ...
    impl<M: ::ethers::providers::Middleware> IPTokenFactoryEvents<M> {
        ...
        pub fn p_token_deployed_filter(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, PtokenDeployedFilter>
        {
            self.0.event()
        }
