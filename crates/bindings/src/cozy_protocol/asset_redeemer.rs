...
pub mod asset_redeemer {
    ...
    pub static ASSETREDEEMER_ABI: ::ethers_contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M> ::core::fmt::Debug for AssetRedeemer<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(AssetRedeemer))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> AssetRedeemer<M> {
        ...
        pub fn redeem(
            ...
            owner: ::ethers::core::types::Address,
        ) -> ::ethers_contract::builders::ContractCall<M, (u64, ::ethers::core::types::U256)>
        {
            self.0
        ...
        pub fn events(
            &self,
        ) -> ::ethers_contract::builders::Event<::std::sync::Arc<M>, M, AssetRedeemerEvents>
        {
            self.0
                .event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers_contract::Contract<M>> for AssetRedeemer<M> {
