pub use metadata::*;
pub mod metadata {
    pub static ICOSTMODEL_NAME: &str = "ICostModel";
    pub static ICOSTMODEL_PATH: &str = "contracts/interfaces/ICostModel.sol";
    pub static COSTMODELJUMPRATEFACTORY_NAME: &str = "CostModelJumpRateFactory";
    pub static COSTMODELJUMPRATEFACTORY_PATH: &str = "contracts/CostModelJumpRateFactory.sol";
    pub static IDRIPDECAYMODEL_NAME: &str = "IDripDecayModel";
    pub static IDRIPDECAYMODEL_PATH: &str = "contracts/interfaces/IDripDecayModel.sol";
    pub static COSTMODELDYNAMICLEVEL_NAME: &str = "CostModelDynamicLevel";
    pub static COSTMODELDYNAMICLEVEL_PATH: &str = "contracts/CostModelDynamicLevel.sol";
    ...
    pub static COSTMODELJUMPRATE_PATH: &str = "contracts/CostModelJumpRate.sol";
    pub static BASEMODELFACTORY_NAME: &str = "BaseModelFactory";
    pub static BASEMODELFACTORY_PATH: &str = "contracts/abstract/BaseModelFactory.sol";
